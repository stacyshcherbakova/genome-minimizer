...
MODEL_PATH = os.path.join(PROJECT_ROOT, "models/trained_models/v1_run/saved_VAE_v1.pt")
FIGURE_DIR = os.path.join(PROJECT_ROOT, "models/v1/figures/")
...
if __name__ == "__main__":
    ...
    plt.savefig(os.path.join(FIGURE_DIR, "latent_space_v1.pdf"), format="pdf", bbox_inches="tight")
    plt.show()
    ...
    plt.savefig(FIGURE_DIR+"f1_scores_v1.pdf", format="pdf", bbox_inches="tight")

    # Samples size distribution plot (Figure 2g, h, i)
    plot_samples_distribution(binary_generated_samples, FIGURE_DIR+"normal_genomes_distribution_v1.pdf", plot_color, 2000, 5000)
    ...
    plot_essential_genes_distribution(essential_genes_count_per_sample, FIGURE_DIR+"essential_genes_distribution_v1.pdf", plot_color, 250, 327)
